...
import {
    ...
    font_letterspacing_neg_small, font_letterspacing_neg_xlarge,
    font_lineheight, font_lineheight_large, font_size_large, font_size_medium,
    font_size_small, font_size_xlarge,
    font_stack,
    font_weight_bold,
    font_weight_medium,
    font_weight_normal
...
export const fontUINeg = (size: string, weight: string) => {
    return css`
        ...
        //weight 
        font-weight: ${weight === "bold" ? font_weight_bold : weight === "medium" ? font_weight_medium : font_weight_normal};
